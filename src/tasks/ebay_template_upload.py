...
col_temp = mongodb['ebay_template_test']
        ...
        try:
            ...
            data = {
                ...
                "Item": {
                    ...
                    "ConditionID": template['SiteInfo']['ConditionID'],
                    ...
                    # },
                    "Quantity": int(template['GoodsInfo']['Quantity']),
                    # 剩余物品最小值
                    # "QuantityInfo": {
                    ...
                    "SiteId": int(template['SiteInfo']['Site']),
            ...
            # print(template['PictureInfo']['PictureURL'][:12])
            if template['SiteInfo']['SecondCategory'] and int(template['GoodsInfo']['LotSize']) > 1:
